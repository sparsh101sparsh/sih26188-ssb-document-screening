...
data class MrzDetails(
    ...
    @Json(name = "doc_number_checksum_valid") val docNumberChecksumValid: Boolean? = null,
    @Json(name = "dob_checksum_valid") val dobChecksumValid: Boolean? = null,
    @Json(name = "expiry_checksum_valid") val expiryChecksumValid: Boolean? = null,
    @Json(name = "composite_checksum_valid") val compositeChecksumValid: Boolean? = null,
    @Json(name = "optional_data_checksum_valid") val optionalDataChecksumValid: Boolean? = null,
