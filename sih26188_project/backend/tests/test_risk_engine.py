...
class TestStage1HardTripwires:
    ...
    def test_tripwire_3_photo_splicing_detected(self):
        """TRIPWIRE_3: Portrait photo splicing detected via TruFor (>0.75) or tamper density (>0.80)."""
        # Case A: photo_tamper_density > 0.80
        assessment_a = risk_scorer.evaluate(photo_tamper_density=0.85)
